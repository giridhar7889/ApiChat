...
class _AbstractChat(metaclass=abc.ABCMeta):
    ...
    def send(self, message):
        ...
        response = requests.post(
            self._server_url + _SEND_URL, data={"id": self._chat_id, "msg": message}
        )
    ...
    def disconnect(self):
        ...
        """
        response = requests.post(
            self._server_url + _DISCONNECT_URL, data={"id": self._chat_id}
        )
        self._chat_ready_flag = False
    ...
    def start_typing(self):
        ...
        """
        response = requests.post(
            self._server_url + _TYPING_URL, data={"id": self._chat_id}
        )
    ...
    def stop_typing(self):
        ...
        """
        response = requests.post(
            self._server_url + _STOPPED_TYPING_URL, data={"id": self._chat_id}
        )
    ...
    def _get_new_events(self):
        while True:
            response = requests.post(
                self._server_url + _EVENTS_URL, data={"id": self._chat_id}
            )
